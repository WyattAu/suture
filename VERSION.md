...
| Feature | Status |
|---------|--------|
| LFS push/pull via hub batch API | [x] Complete |
| Sync daemon push/pull reconciliation | [x] Complete |
| merge --continue / merge --abort | [x] Complete |
| LFS checkout pointer resolution | [x] Complete |
| Hub LFS integration tests (4 tests) | [x] Complete |
| Snapshot migration tests (4 tests) | [x] Complete |
...
|-------|-----------|-------|---------------|--------|
| **A** | Product Polish | Hub as self-hosted GitLab/Gitea portal | v1.3 – v1.4 | [x] Complete |
| **B** | Enterprise Infra | VFS mount + Daemon + SHM + gRPC | v2.0 – v2.5 | [x] Complete |
| **C** | Ecosystem Growth | Drivers, plugins, language bindings | v2.5+ | [x] Complete |
| **D** | Hardening | Wire scaffolds, Raft, S3, mount manager, JetBrains, Python | v2.6 | [x] Complete |
| **E** | Ship It | Distribution, docs, packaging, release automation | v2.7 | [x] Complete |
| **F** | Production Hardening | S3/Raft integration, benchmarks, integration tests | v2.8 | [x] Complete |
| **G** | Growth | VS Code, webhooks, desktop UI, perf fix | v2.9 | [x] Complete |
| **H** | Validate & Ship | Release prep, shipping checklist, release script | v2.10 | [x] Complete |
| **I** | Depth over Breadth | Wire S3 and Raft into hub's actual runtime | v2.10 | [x] Complete |
| **J** | Make Raft Work | TCP transport wired, multi-node cluster, persist log | v3.0 | [x] Complete |
| **K** | Production Readiness | Health check, graceful shutdown, config, tracing, rate limit | v3.0 | [x] Complete |
| **L** | Performance & Scale | Batch patches, scale benchmarks | v3.0 | [x] Complete |
| **M** | Real Desktop App | CLI commands, system tray, repo integration | v3.0 | [x] Complete |
| **N** | Ecosystem Polish | VS Code LSP, interactive demo | v3.0 | [x] Complete |
| **O** | Publish & Distribute | crates.io, Homebrew, AUR, install verification | v3.1 | [x] Complete |
| **P** | Driver Audits | 63 correctness tests for DOCX/XLSX/PPTX/PDF/OTIO/Image | v3.1 | [x] Complete |
| **Q** | Semantic Diff | File-type-aware diff, structured output, icons | v3.1 | [x] Complete |
| **R** | Domain Workflows | --type flag, file-type icons, domain-aware init/status | v3.1 | [x] Complete |
| **S** | Domain Marketing | README rewrite, 5 domain pages, why-suture, vs-git | v3.1 | [x] Complete |
| **T** | Actually Ship | Publish prep, release build script, binary verification | v3.2 | [x] Complete |
| **U** | CI/CD | GitHub Actions CI, release workflow, dependabot, issue templates | v3.2 | [x] Complete |
| **V** | Driver Validation | 58 realistic tests for DOCX/XLSX/PPTX/PDF/OTIO/Image | v3.2 | [x] Complete |
| **W** | Workflow Reliability | 7 E2E workflow tests (basic, merge, conflict, branch, history, stash) | v3.2 | [x] Complete |
| **X** | Performance Baseline | 16 benchmarks, docs/performance.md, quick optimizations | v3.2 | [x] Complete |
| **1A** | Enhanced Undo/Reflog/Doctor | Reflog-aware undo, doctor command, structured reflog | v3.3 | [x] Complete |
| **1B** | Merge Strategies | --strategy flag (semantic/ours/theirs/manual), dry-run | v3.3 | [x] Complete |
| **1C** | GC/fsck Hardening | Transactional GC, blob pruning, fsck fixes | v3.3 | [x] Complete |
| **1D** | Merge Stress Tests | 12 E2E stress tests: multi-file, deep history, diamond, strategies | v3.3 | [x] Complete |
| **1E** | Supply Chain Integrity | Shannon entropy, risk scoring, --integrity diff mode | v3.3 | [x] Complete |
| **2A** | Video/OTIO Depth | 8 deep tests: reordering, transitions, nesting, 500-clip perf | v3.4 | [x] Complete |
| **2B** | Document Collab Depth | 9 deep tests: DOCX/XLSX/PPTX conflicts, large docs, formulas | v3.4 | [x] Complete |
| **3A** | Git Bridge | `suture git import/log/status`, read-only Git→Suture import | v3.4 | [x] Complete |
| **3B** | Shell Completions | bash/zsh/fish/powershell/nushell (already done in v3.1) | v3.4 | [x] Complete |
| **3C** | TUI Conflict Resolver | Line-by-line hunk resolution, ours/theirs/both, navigation | v3.4 | [x] Complete |
| **4A** | suture-merge Library | Standalone merge library crate, 10 drivers, published to crates.io | v3.7 | [x] Complete |
| **4B** | Binary Document E2E | 71 E2E tests for DOCX/XLSX/PPTX full VCS lifecycle | v3.7 | [x] Complete |
| **4C** | Hardening & Stabilize | 4 bug fixes, full workspace 0 failures, 1396 tests | v4.0 | [x] Complete |
| **5A** | OTIO Driver Rewrite | SutureDriver trait, content-based ID, three-way merge, Gap/Marker support | v4.0 | [x] Complete |
| **5B** | OOXML Driver Deepening | Fix XLSX cell refs, PPTX slide discovery, DOCX in-place merge | v4.0 | [x] Complete |
| **5C** | Distribution & Adoption | Installers, migration tooling, documentation overhaul | v4.1 | [~] In Progress |
| **6D** | Library v0.2 + GitHub Action | suture-merge v0.2 with DOCX/XLSX/PPTX, suture-action, blog post, dep bumps | v4.1 | [x] Complete |
| **7A** | Production VCS CLI | 10 new commands/flags, progress indicators, binary diff fix | v4.1 | [x] Complete |
| **8A** | Version Unification | All crates bumped to v5.0.0 for coherent publishing | v5.0 | [x] Complete |
| **8B** | Release Pipeline | GitHub Actions binary release (Linux/macOS/Windows) | v5.0 | [x] Complete |
| **8C** | Quickstart | 60-second quickstart for non-developers | v5.0 | [x] Complete |
| **9A** | Defence: Audit Trail | `suture log --audit` with JSON/CSV/text export | v5.0 | [x] Complete |
| **9B** | Defence: Classification | `suture diff --classification` marking change detection | v5.0 | [x] Complete |
| **9C** | OOXML Conflict UX | OOXML conflicts preserve file integrity, generate report | v5.0 | [x] Complete |
| **9D** | Export Command | `suture export` for clean client delivery | v5.0 | [x] Complete |
| **9E** | Template Repos | `suture init --template document|video|data|report` | v5.0 | [x] Complete |
| **10A** | Onboarding | Welcome banner on first `suture init` | v5.0 | [x] Complete |
| **11A** | Diff Summary | `suture diff --summary` for non-technical stakeholders | v5.0 | [x] Complete |
| **11B** | Doctor Fix | `suture doctor --fix` auto-remediation | v5.0 | [x] Complete |
| **11C** | Log Graph Polish | Merge lines, HEAD labels, relative time, author names | v5.0 | [x] Complete |
| **11D** | Ignore Improvements | Negation patterns, directory-only, rule attribution | v5.0 | [x] Complete |
| **12A** | Sync Command | `suture sync` — auto-commit, pull, push (Google Drive replacement) | v5.0 | [x] Complete |
| **12B** | Hook Management | `suture hook list/run/edit` + pre-commit/pre-push wiring | v5.0 | [x] Complete |
| **12C** | Remote Rename | `suture remote rename` for renaming remotes | v5.0 | [x] Complete |
| **13A** | Tag Improvements | `suture tag --list "v3.*"` pattern filter, `--sort date|name` | v5.0 | [x] Complete |
| **13B** | Reflog Show | `suture reflog --show` with full patch details | v5.0 | [x] Complete |
| **13C** | Notes Append | `suture notes add --append` for appending to notes | v5.0 | [x] Complete |
| **13D** | Show Stat | `suture show --stat` with file classification | v5.0 | [x] Complete |
| **14A** | Verify Signing | `suture verify` per-commit Ed25519 signature verification | v5.0 | [x] Complete |
| **14B** | Stash Show | `suture stash show` preview stash contents | v5.0 | [x] Complete |
| **14C** | Clean | `suture clean` remove untracked files (--dry-run, --dirs) | v5.0 | [x] Complete |
| **14D** | Blame Line Range | `suture blame -L 10,20` line range filtering | v5.0 | [x] Complete |
| **14E** | Describe | `suture describe` describe commit by nearest tag | v5.0 | [x] Complete |
| **14F** | Rev-Parse | `suture rev-parse` resolve refs for scripting | v5.0 | [x] Complete |
| **15A** | Apply | `suture apply` unified diff application (--stat, --reverse) | v5.0 | [x] Complete |
| **15B** | Pull Autostash | `suture pull --autostash`, `cherry-pick --no-commit` | v5.0 | [x] Complete |
| **15C** | Log/Gc/Fsck Flags | `log --diff-filter`, `gc --dry-run/--aggressive`, `fsck --full` | v5.0 | [x] Complete |
| **15D** | Stash/Worktree | `stash save/clear`, `worktree prune` | v5.0 | [x] Complete |
| **16** | E2E Workflow Tests | Defence, film, YouTube, general workflow validation (11 tests) | v5.0 | [x] Complete |
| **18** | Test Sweep | Full workspace: 1,419 tests, 0 failures, test isolation | v5.0 | [x] Complete |
| **19** | Publish Prep | 33-crate publish script, dry-run verified, README refresh | v5.0 | [x] Complete |
| **20** | README v5.0.0 | Refreshed README with all features, verticals, install options | v5.0 | [x] Complete |
| **21A** | npm Package | suture-merge-driver npm package with auto-download | v5.0 | [x] Complete |
| **21B** | Blog + Docs | Blog post, merge driver guide, release notes | v5.0 | [x] Complete |
| **22** | Desktop App v5 | Tauri backend (26 commands) + dark theme HTML UI | v5.0 | [x] Complete |
| **23A** | Tamper-Evident Audit | BLAKE3 hash chain audit log, suture audit command | v5.0 | [x] Complete |
| **23B** | Classification Scan | Bulk classification scan across repo history | v5.0 | [x] Complete |
| **24A** | Film Timeline | suture timeline import/export/summary/diff (OTIO) | v5.0 | [x] Complete |
| **24B** | YouTube Batch | suture report, batch ops, export templates | v5.0 | [x] Complete |
| **26** | VS Code Extension | Merge driver config, repo commands, auto-detect | v5.0 | [x] Complete |
| **27** | Final Sweep | 1,436 tests, 0 failures, all docs updated | v5.0 | [x] Complete |
| **28** | Performance | 5 bottlenecks: lazy patches, topo sort O(n), fast classify, hex lookup, Rc ancestors | v5.0 | [x] Complete |
| **29** | Security | 7 fuzz targets, dependency audit, wasmtime note | v5.0 | [x] Complete |
| **31** | CI/CD | Dependabot, security scanning, test matrix, issue templates | v5.0 | [x] Complete |
| **32A** | Man Pages | 62 roff man pages + Makefile + generator script | v5.0 | [x] Complete |
| **32B** | Error Messages | User-friendly errors with fuzzy suggestions (13 commands) | v5.0 | [x] Complete |
| **33A** | Shell Completions | All 60+ commands auto-covered via clap | v5.0 | [x] Complete |
| **33B** | API Docs | Rustdoc for Repository, Patch, PatchDag, AuditLog | v5.0 | [x] Complete |
| **34** | Node.js Bindings | suture-node: 15 napi-rs functions + TypeScript types | v5.0 | [x] Complete |
| **35** | E2E Tests | 16 workflow tests (defence, film, YouTube, general) | v5.0 | [x] Complete |
| **36** | Desktop Guide | Platform build instructions for Linux/macOS/Windows | v5.0 | [x] Complete |
| **37** | Fix Compilation | suture-vfs Send/Sync, suture-lsp Send bound, fuzz imports | v5.0 | [x] Complete |
| **38** | Proptest + Benchmarks | 17 proptests, Criterion benchmarks for repo + merge | v5.0 | [x] Complete |
| **39** | Landing Page | GitHub Pages responsive dark-theme SPA (docs/index.html) | v5.0 | [x] Complete |
| **40** | Example Projects | 4 use cases: JSON config, film timeline, YouTube, i18n | v5.0 | [x] Complete |
| **41** | Clippy Cleanup | Core crates clippy-clean, auto-fixes across 5 crates | v5.0 | [x] Complete |
| **42** | Cross-Platform CI | macOS + Windows test matrix, --test-threads=1 | v5.0 | [x] Complete |
| **43** | Documentation | CONTRIBUTING.md + ARCHITECTURE.md | v5.0 | [x] Complete |
| **44** | Final Verification | 1,171 tests, 0 failures, 2 ignored | v5.0 | [x] Complete |
| **45** | Batch Merge Fix | File-level 3-way merge for conflicting batch patches, raft determinism | v5.0 | [x] Complete |
| **46** | Security Hardening | Path traversal fix, unsafe impl Sync removal, token leakage fix, blob limits | v5.0 | [x] Complete |
| **47** | OTIO Fix + from_utf8_unchecked | merge_trees nesting fix, merge_raw/diff_raw trait migration | v5.0 | [x] Complete |
| **48** | Production Polish | Incremental snapshots, zero clippy, binary conflicts, undo/rollback, LFS, sync status | v5.0 | [x] Complete |

### Direction 45 — Batch Merge Fix (v5.0) [x]
...
### Direction 46 — Security Hardening (v5.0) [x]
...
### Direction 47 — Binary Driver Safety (v5.0) [x]
...
### Direction 48 — Production Polish (v5.0) [x]
...
### Direction A — Product Polish (v1.3–v1.4) [x]
...
### Direction B — Enterprise Infrastructure (v2.0–v2.5) [x]
...
### Direction C — Ecosystem Growth (v2.5) [x]
...
### Direction F — Production Hardening (v2.8) [x]
...
### Direction H — Validate & Ship (v2.10) [x]
...
### Direction I — Depth over Breadth (v2.10) [x]
...
### Direction J — Make Raft Work (v3.0) [x]
...
### Direction K — Production Readiness (v3.0) [x]
...
### Direction L — Performance & Scale (v3.0) [x]
...
### Direction M — Real Desktop App (v3.0) [x]
...
### Direction N — Ecosystem Polish (v3.0) [x]
...
### Direction O — Publish & Distribute (v3.1) [x]
...
### Direction P — Driver Correctness Audits (v3.1) [x]
...
### Direction Q — Semantic Diff Visualization (v3.1) [x]
...
### Direction R — Domain-Specific Workflows (v3.1) [x]

- `suture init --type video|document|data` with auto-detect from existing files
- `suture status` shows file-type icons: [DOC][DATA][VIDEO][VIDEO][IMG][LIST]
- `.suture/config` stores repo type for workflow customization

### Direction S — Domain Marketing (v3.1) [x]
...
### Direction 1A — Enhanced Undo/Reflog/Doctor (v3.3) [x]
...
### Direction 1B — Merge Reconciliation Strategies (v3.3) [x]
...
### Direction 1C — GC/fsck Hardening (v3.3) [x]
...
### Direction 1D — Merge Correctness Stress Tests (v3.3) [x]
...
### Direction 1E — Supply Chain Integrity Analysis (v3.3) [x]
...
### Direction 2A — Video/OTIO Domain Depth (v3.4) [x]
...
### Direction 2B — Document Collaboration Depth (v3.4) [x]
...
### Direction 3A — Git Bridge (v3.4) [x]
...
### Direction 3B — Shell Completions (v3.4) [x]
...
### Direction 4A — suture-merge Library & Binary E2E (v3.5–v3.7) [x]
...
### Direction 4C — Hardening & Stabilize (v4.0) [x]
...
### Direction 5A — OTIO Driver Rewrite (v4.0) [x]
...
### Direction 5B — OOXML Driver Deepening (v4.0) [x]
...
### Direction 6D — Library v0.2 + GitHub Action (v4.1) [x]
...
### Direction 7A — Production VCS CLI (v4.1) [x]
...
### Direction 8A — Version Unification (v5.0) [x]
...
### Direction 8B — Release Pipeline (v5.0) [x]
...
### Direction 8C — Quickstart (v5.0) [x]
...
### Direction 9A — Defence: Audit Trail (v5.0) [x]
...
### Direction 9B — Defence: Classification Detection (v5.0) [x]
...
### Direction 9C — OOXML Conflict UX (v5.0) [x]
...
### Direction 9D — Export Command (v5.0) [x]
...
### Direction 9E — Template Repos (v5.0) [x]
...
### Direction 10A — Onboarding (v5.0) [x]
...
| Gate | Status | Details |
|------|--------|---------|
| Tests | [x] 1,759 passing | 0 failures across 37 crates (20 ignored: perf 10K, merge-driver scripts, platform external) |
...
| Editor plugins | [x] 3 plugins | Neovim (Lua), JetBrains IntelliJ (Kotlin), VS Code (TypeScript) |
| Language bindings | [x] 2 bindings | Node.js (napi-rs), Python (PyO3) |
...
| suture-e2e | 200 | End-to-end workflow tests + driver correctness tests + integrity E2E tests |
