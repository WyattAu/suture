...
| Gate | Status | Details |
|------|--------|---------|
| Tests | ✅ 203 passing | 0 failures across 6 crates |
...
| suture-core | 167 | Core engine (CAS, DAG, patches, repo, engine, signing, merge) |
| suture-cli | 0 | CLI binary (init, status, add, commit, branch, log, merge, checkout, diff, revert, tag, config, key, push, pull, remote) |
