...
- **Current Version:** 2.1.0-alpha.1
- **Current Phase:** Direction B — Daemon + SHM (v2.1)
- **Status:** In Progress
...
| Gate | Status | Details |
|------|--------|---------|
| Tests | ✅ 790 passing | 0 failures across 22 crates |
...
| HTTP integration | ✅ 35 tests | handshake, repos, patches, push/pull, V2, auth, mirrors, CRUD, search |
