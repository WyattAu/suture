...
pub fn hash_password(password: &str) -> anyhow::Result<String> {
    salting_hash(password).map_err(|e| anyhow::anyhow!("password hashing failed: {e}"))
}

pub fn verify_password(password: &str, hash: &str) -> anyhow::Result<bool> {
    salting_verify(password, hash).map_err(|e| anyhow::anyhow!("password verification failed: {e}"))
}
...
pub fn create_jwt(
    ...
    let claims = Claims {
        ...
        iss: Some("suture-platform".to_owned()),
